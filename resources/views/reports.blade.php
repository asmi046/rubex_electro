...
@section('content')
        ...
        <section class="descpBlock">
			...
			<ul class="descpBlock__list">
				...
				<li><a target="_blank" class="descpBlock__list-item" href="{{asset('teplo_report/Информация_по_отпуску_тепловой_энергии_потребителям,_подключённым_2024.pdf')}}">Информация по отпуску тепловой энергии потребителям,подключённым к тепловым сетям ОАО Курскрезинотехника</a></li>
			</ul>
{{--
			<h2 class="descpBlock__title">УСЛУГИ ПО ОТПУСКУ ТЕПЛОВОЙ ЭНЕРГИИ</h2>
